...
commandString="singularity exec --nv /extra/hossain/gdocker.simg python3 multi_application.py {0} 3 > outputs/{1}/st_out/output_{0}.txt"
...
for i in range(1, 12):
    job_name="graphbinary"+str(i)+ expprefix
